...
<head>
  ...
  <title>Atualizar de Veiculos</title>
</head>
...
<body>
  ...
  <form method="POST" class="row g-3 m-5 ">
    ...
    <div class="col-12 ">
      <input class="btn btn-primary" id="botao" type="submit" name="atualizar" value="Atualizar">


    </div>
    <button class="btn btn-dark " id="btn" type="button"><a href="listar.php" style="text-decoration: none;">Voltar</a></button>
